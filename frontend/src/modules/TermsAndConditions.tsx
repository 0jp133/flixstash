  ...
  return (
    <section className="section">
      <div className="container">
        <h1 className="title is-2">Terms and conditions</h1>
        <div>
          <div className="content">
            <p>Welcome to flixstash!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of flixstash's Website, located at flixstash.dev.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use flixstash if you do not agree
            ...
            <p>
              We employ the use of cookies. By accessing flixstash, you agreed
              to use cookies in agreement with the flixstash's Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, flixstash and/or its licensors own the
              intellectual property rights for all material on flixstash. All
              intellectual property rights are reserved. You may access this
              from flixstash for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from flixstash</li>
              <li>Sell, rent or sub-license material from flixstash</li>
              <li>Reproduce, duplicate or copy material from flixstash</li>
              <li>Redistribute content from flixstash</li>
            </ul>
            ...
            <p>
              ...
              flixstash; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to flixstash. Please include your name, your
            ...
            <p>
              No use of flixstash's logo or other artwork will be allowed for
